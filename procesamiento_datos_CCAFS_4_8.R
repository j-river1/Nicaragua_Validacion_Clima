...
files <- list.files(here::here('CCAFS_4_8'),full.names = T)
files_CCAFS <- lapply(list.files("./CCAFS_4_8"), function (x)
{
    #Read file 
    file <- read.table(paste0(getwd(),"/CCAFS_4_8/",x), header=T)
...
#Name of stations
nam_files_CCAFS <- list.files(here::here('CCAFS_4_8'),full.names = F)
...
read_join <- lapply(nam_CCAFS, function (x){
    ...
    #Read files
    files <- list.files(here::here('CCAFS_4_8'),full.names = F, pattern = x)
    complete_names <- paste0(here::here('CCAFS_4_8'), "/",files)
...
files_aWhere <- lapply(list.files(here::here('Datos_Awhere_4_8'),full.names = T),read.xls)
nam_files_aWhere <- list.files(here::here('Datos_Awhere_4_8'))
...
ggsave(here::here('RESULTADOS','CCAFS_4_8', 'quality_awhere_CCFSA.png'),g,width =10 ,height =5 )
ggsave(here::here('RESULTADOS','CCAFS_4_8','quiality_awhere_CCFSA_2.png'),g1,width =10 ,height =5 )
...
ggsave(here::here('RESULTADOS', 'CCAFS_4_8', 'Validacion.png'),gEnd,height = 8,width =10 )
